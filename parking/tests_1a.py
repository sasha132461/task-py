...
def test_load_parking_records():
    ...
    with open("parking/test_files/parking_records.pkl", 'rb') as infile:
...
def test_load_prices():
    ...
    with open("parking/test_files/parking_prices.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_calculate_parking_time():
    ...
    with open("parking/test_files/parking_times.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_get_parking_fee():
    ...
    with open("parking/test_files/parking_fees.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_calculate_average_parking_fee():
    ...
    with open("parking/test_files/average_parking_fees.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_calculate_average_parking_time():
    ...
    with open("parking/test_files/average_parking_times.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_calculate_average_parking_stays():
    ...
    with open("parking/test_files/average_parking_stays.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_get_most_common_region():
    ...
    with open("parking/test_files/most_common_regions.pkl", 'rb') as infile:
        correct = pickle.load(infile)
...
def test_get_busiest_hour():
    ...
    with open("parking/test_files/busiest_hours.pkl", 'rb') as infile:
        correct = pickle.load(infile)
